...
window.WritingStatsConfig = {
  ...
  referenceKeys: %s,
  spellcheckEnabled: %s,
  spellcheckProvider: %s,
  spellcheckEndpoint: %s,
  spellcheckLanguage: %s,
  spellcheckIgnoreTerms: %s,
  spellcheckTimeoutMs: %s,
  nlpCdn: %s,
  nlpCdnUrl: %s,
  doiValidation: %s
};
      ...
      js_bool(meta_bool(cfg["spellcheck"], false)),
      js_json(cfg["spellcheck-provider"], '"languagetool"'),
      js_json(cfg["spellcheck-endpoint"], '"https://api.languagetool.org/v2/check"'),
      js_json(cfg["spellcheck-language"], '""'),
      js_json(cfg["spellcheck-ignore-terms"], "[]"),
      meta_num(cfg["spellcheck-timeout-ms"], 8000),
